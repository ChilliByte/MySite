...
for (var i = 0; i < numNodes; i++) {
	...
	hoverDiv.setAttribute("style","left: " + (nodes[i].x - 15) + "px; top: " + (nodes[i].y - 15) + "px;");
	...
	for(var i = 0; i < numNodes; i++) {
		...
		*/
		...
		if (play) {
			...
			document.getElementById(nodes[i].name).style = "left: " + (nodes[i].x - 15) + "px; top: " + (nodes[i].y - 15) + "px;";
		}
	}
}
